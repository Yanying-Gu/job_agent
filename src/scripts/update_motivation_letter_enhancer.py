"""Sync the motivation_letter_enhancer prompt into its workflow JSON definition."""
...
# Add src directory to path so we can import job_agent if needed
...
WORKFLOW_PATH = REPO_ROOT / "workflow" / "motivation_letter_enhancer.json"
PROMPT_PATH = (
    REPO_ROOT
    / "prompts"
    / "motivation_letter_enhancer"
    / "motivation_letter_enhancer_prompt_v1.txt"
)
